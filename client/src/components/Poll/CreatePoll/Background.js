...
const Background = () => {
    ...
    return (
        <div style={{marginTop: '120px', marginLeft:"50px"}}>
            ...
            <Button variant="contained" className={classes.button} style={{backgroundColor: 'white', border: '1px solid grey'}}></Button>
            <Button variant="contained" className={classes.button} style={{backgroundColor: 'black'}}></Button>
            <Button variant="contained" className={classes.button} style={{backgroundColor: '#99ddff' /* light blue */, border: '1px solid grey'}}></Button> 
            <Button variant="contained" className={classes.button} style={{backgroundColor: '#ffff4d' /* light yellow */, border: '1px solid grey'}}></Button>
            <Button variant="contained" className={classes.button} style={{backgroundColor: '#005580' /* blue */, border: '1px solid grey'}}></Button>
            <Button variant="contained" className={classes.button} style={{backgroundColor: 'red', border: '1px solid grey'}}></Button>
            <Button variant="contained" className={classes.button} style={{backgroundColor: 'brown', border: '1px solid grey'}}></Button>
