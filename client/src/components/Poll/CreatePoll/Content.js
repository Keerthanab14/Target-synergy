  ...
  const handleAddClick = () => {
    ...
    return (
      <div >
        ...
        <TextField id="outlined-basic" label="Your multiple choice question" variant="outlined" size="small" onChange={(e)=>handle(e)} id="question" value={data.question} style={{width: '100%'}}/>
