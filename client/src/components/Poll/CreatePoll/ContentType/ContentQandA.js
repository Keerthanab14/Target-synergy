...
const ContentQandA = (props) => {
    ...
    function handle(e){
      const newdata={...props.QandA}
      newdata[e.target.id]=e.target.value
      props.setQandA(newdata)
      console.log(newdata)
    }
    ...
    return (
      ...
      <TextField id="outlined-basic" label="Your question" variant="outlined" size="small" onChange={(e)=>handle(e)} id="question" value={props.QandA.question} type="text" style={{width: '100%'}} />
