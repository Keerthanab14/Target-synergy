...
const ContentQandA = ({data6, setData6,handleChangeIndex}) => {
 ...
 return (
   ...
   <TextField id="outlined-basic" label="Your question" variant="outlined" size="small" onChange={(e)=>handle(e)} id="question" value={data6.question} type="text" style={{width: '100%'}} />
