...
const Presentation = ({color, textcolor, component, opacity, img, data1, data2, data3,data5,data4,data6, result, inputList1, inputListScales, inputList2}) => {
    ...
    return (
        ...
        {component === 'ranking' && <Ranking data2={data2} inputList={inputList2}  />} 
